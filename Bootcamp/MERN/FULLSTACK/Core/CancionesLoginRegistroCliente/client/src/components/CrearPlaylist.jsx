...
import { Stack, TextField, Typography, Button, Checkbox, FormGroup, FormControlLabel, FormHelperText, FormControl } from '@mui/material'
import { useNavigate, useParams } from 'react-router-dom';

const CrearPlaylist = () => {

    // const { usuario } = useContext(UserContext.UserContext)
